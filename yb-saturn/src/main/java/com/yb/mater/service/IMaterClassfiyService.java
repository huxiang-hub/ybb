 ...
 * @since 2020-03-10
 */
public interface IMaterClassfiyService extends IService<MaterClassfiy> {

    /**
     * 自定义分页
     *
     * @param page
     * @param materClassfiyVO
     * @return
     */
    IPage<MaterClassfiyVO> selectMaterMtinfoPage(IPage<MaterClassfiyVO> page, MaterClassfiyVO materClassfiyVO);
