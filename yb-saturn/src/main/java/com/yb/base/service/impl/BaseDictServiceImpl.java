...
public class BaseDictServiceImpl extends ServiceImpl<BaseDictMapper, BaseDict> implements IBaseDictService {
    ...
    @Override
    public IPage<BaseDictVO> selectBaseDictPage(IPage<BaseDictVO> page, BaseDictVO baseDict) {
        return page.setRecords(baseMapper.selectBaseDictPage(page, baseDict));
    }
