...
/**
 * 设备扩展信息_yb_machine_bsinfo Mapper 接口
 *
 * @author Blade
 * @since 2020-03-10
 */
@Mapper
public interface MachineBsinfoMapper extends BaseMapper<MachineBsinfo> {
     ...
     * @return
     */
    List<MachineBsinfoVO> selectMachineBsinfoPage(IPage page, MachineBsinfoVO machineBsinfo);
    /**
     * 获取设备基本信息
