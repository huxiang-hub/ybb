 ...
 */
@Data
@TableName("yb_store_dislocatlog")
@Accessors(chain = true)
@ApiModel(value = "盘错位置管理_yb_store_dislocatlogStoreDislocatlog实体")
public class StoreDislocatlog implements Serializable {
    ...
    @ApiModelProperty(value = "当前位置编码")
    @TableField("curr_local")
    private String currLocal;


    @ApiModelProperty(value = "之前库位编码")
    @TableField("bef_local")
    private String befLocal;
