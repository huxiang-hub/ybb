...
/**
 * OEE数据信息表_yb_statis_ordfull（OEE的全量统计-状态变更及中间定时5分钟已上报记录）实体类
 *
 * @author Blade
 * @since 2020-03-10
 */
...
@ApiModel(value = "StatisOrdfull对象", description = "OEE数据信息表_yb_statis_ordfull（OEE的全量统计-状态变更及中间定时5分钟已上报记录）")
public class StatisOrdfull implements Serializable {
