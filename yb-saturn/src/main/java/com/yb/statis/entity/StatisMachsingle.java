 ...
 */
@Data
@TableName("yb_statis_machsingle")
@ApiModel(value = "StatisMachsingle对象", description = "StatisMachsingle对象")
public class StatisMachsingle implements Serializable {
    ...
    /**
     * OEE对应设备类型的标准对应表ID一对一
     */
    @ApiModelProperty(value = "OEE对应设备类型的标准对应表ID一对一")
