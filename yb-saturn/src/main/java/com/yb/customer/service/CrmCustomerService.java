 ...
 */
package com.yb.customer.service;
...
public interface CrmCustomerService extends IService<CrmCustomer> {
     ...
     * @return
     */
    IPage<CrmCustomerVO> selectCrmCustomerPage(IPage<CrmCustomerVO> page, CrmCustomerVO crmCustomer);
     ...
     * @return
     */
    CrmCustomerVO getOneByCmName(String cmName);
