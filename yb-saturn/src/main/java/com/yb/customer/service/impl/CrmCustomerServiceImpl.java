 ...
 */
package com.yb.customer.service.impl;
...
public class CrmCustomerServiceImpl extends ServiceImpl<CrmCustomerMapper, CrmCustomer> implements CrmCustomerService {
    ...
    @Override
    public IPage<CrmCustomerVO> selectCrmCustomerPage(IPage<CrmCustomerVO> page, CrmCustomerVO crmCustomer) {
        return page.setRecords(baseMapper.selectCrmCustomerPage(page, crmCustomer));
    }

    @Override
    public CrmCustomerVO getOneByCmName(String cmName) {
        return baseMapper.getOneByCmName(cmName);
    }
