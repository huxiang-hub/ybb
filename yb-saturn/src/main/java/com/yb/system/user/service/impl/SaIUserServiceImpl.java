...
public class SaIUserServiceImpl extends BaseServiceImpl<SaUserMapper, SaUser> implements SaIUserService {
    ...
    public boolean resetPassword(String userIds) {
        SaUser saUser = new SaUser();
        saUser.setPassword(DigestUtil.encrypt(MD5Utils.encodeByMD5(CommonConstant.DEFAULT_PASSWORD)));
...
//查询单个用户信息通过名字，账号
    ...
    @Override
    public void updateAvatarByPhone(String mobile, String userAvatar) {
        baseMapper.updateAvatarByPhone(mobile, userAvatar);
    }

    @Override
    public String getAvatar(String mobile) {
        return baseMapper.getAvatar(mobile);
    }
}
