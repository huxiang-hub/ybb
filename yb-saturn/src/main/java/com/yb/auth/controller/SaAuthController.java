...
import com.yb.auth.granter.SaITokenGranter;
import com.yb.auth.granter.SaTokenGranterBuilder;
import com.yb.auth.granter.SaTokenParameter;
import com.yb.auth.secure.SaAuthInfo;
import com.yb.auth.utils.*;
...
//        }
    ...
    public R<Kv> captcha(HttpServletRequest request, HttpServletResponse response) {
        ...
        redisUtil.set(CacheNames.CAPTCHA_KEY + key, verCode, 5L, TimeUnit.MINUTES);
        //清除登录时创建的cookie
        // 将key和base64返回给前端
