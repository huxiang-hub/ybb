...
import com.sso.chatapi.service.IImChatGroupUserService;
...
import com.sso.mapper.ImUserMapper;
...
public class ImUserServiceImpl extends ServiceImpl<ImUserMapper, ImUser> implements IImUserService {
    ...
    @Override
    public ImUser getFriendInfo(String friendId) {
        return baseMapper.getByFromId(friendId);
    }
}
