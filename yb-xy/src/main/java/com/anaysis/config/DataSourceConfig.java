...
//        DataSource dataSource = builder.build();
    ...
    private DataSource initDDS() throws IllegalArgumentException, IllegalAccessException {
        ...
        dds.setUrl("jdbc:mysql://39.98.57.236:3378/yb_xingyi_pro?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&tinyInt1isBit=false&allowMultiQueries=true&serverTimezone=GMT%2B8");
