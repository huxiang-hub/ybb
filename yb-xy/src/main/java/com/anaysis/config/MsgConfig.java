...
import org.springblade.common.exception.R;
...
public class MsgConfig {
    ...
    // 短信模板 ID，需要在短信应用中申请（报错短信）
    final  static  Integer TEMPLATE_ID = 680177; // NOTE: 这里的模板 ID`7839`只是示例，真实的模板 ID 需要在短信控制台中申请
    // 签名
    ...
    public static String sendStringMessages(String phoneNum,String factory,String error){
        try {
            String[] params = {factory,error};
            SmsSingleSender ssender = new SmsSingleSender(APP_ID, APP_KEY);
            SmsSingleSenderResult result = ssender.sendWithParam("86", phoneNum,
                    TEMPLATE_ID, params, SMS_SIGN, "", "");
