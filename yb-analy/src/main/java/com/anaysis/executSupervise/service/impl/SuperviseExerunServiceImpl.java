...
import com.anaysis.executSupervise.mapper.SuperviseExerunMapper;
import com.anaysis.executSupervise.service.SuperviseExerunService;
...
public class SuperviseExerunServiceImpl implements SuperviseExerunService {
    ...
    @Override
    public int clearByalreadylog(){
        return  exerunMapper.clearByalreadylog();
    }
