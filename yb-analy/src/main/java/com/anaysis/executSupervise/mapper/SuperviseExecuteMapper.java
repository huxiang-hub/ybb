...
public interface SuperviseExecuteMapper extends BaseMapper<SuperviseExecute> {
    ...
    SuperviseExecute getExecutByMaid(Integer maId);

    List<SuperviseExecute> getExecutList(@PathParam("status") String status);

    Map<String, String> getOrderName(Integer sdId);

    int updateC1Byuuid(SuperviseExecute execute);
