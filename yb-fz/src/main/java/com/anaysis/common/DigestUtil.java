...
public class DigestUtil extends org.springframework.util.DigestUtils {
    ...
    public static String md5Hex(final String data) {
        return org.springblade.core.tool.utils.DigestUtil.md5DigestAsHex(data.getBytes(Charsets.UTF_8));
    }
    ...
    public static String md5Hex(final byte[] bytes) {
        return org.springblade.core.tool.utils.DigestUtil.md5DigestAsHex(bytes);
    }
