...
//        DataSource dataSource = builder.build();
    ...
    private DataSource initDDS() throws IllegalArgumentException, IllegalAccessException {
        ...
        dds.setUrl("jdbc:mysql://39.98.57.236:3378/yb_fz_work_pro?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&tinyInt1isBit=false&allowMultiQueries=true&serverTimezone=GMT%2B8");
    ...
    public SqlSessionFactory getSqlSessionFactory(@Qualifier("dataSource") DataSource dataSource) throws Exception {
        ...
        sessionFactory.setMapperLocations(
                new PathMatchingResourcePatternResolver().getResources("classpath:mybatis/mysqlmybatis/*.xml"));
...
//        try {
//            bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mybatis/mysqlmybatis/*.xml"));
//            bean.setDataSource(dataSource);
//            bean.setTypeAliasesPackage("com.anaysis.entity");
